...
use crate::{Error, Schnorrkel25519Merlin};
...
pub fn repair_share_step_2(deltas_j: &[Scalar]) -> Scalar {
    frost::keys::repairable::repair_share_step_2::<Schnorrkel25519Merlin>(deltas_j)
}
...
mod tests {
    ...
    fn check_repair_share_step_1() {
        ...
        frost_core::tests::repairable::check_repair_share_step_1::<Schnorrkel25519Merlin, _>(rng);
    }

    #[test]
    fn check_repair_share_step_2() {
        frost_core::tests::repairable::check_repair_share_step_2::<Schnorrkel25519Merlin>(
            &REPAIR_SHARE,
        );
    }
    ...
    fn check_repair_share_step_3() {
        let rng = thread_rng();
        frost_core::tests::repairable::check_repair_share_step_3::<Schnorrkel25519Merlin, _>(
            rng,
            &REPAIR_SHARE,
        );
    }
