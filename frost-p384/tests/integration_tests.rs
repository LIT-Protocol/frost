...
fn check_refresh_shares_with_dealer() {
    ...
    frost_core::tests::refresh::check_refresh_shares_with_dealer::<P384Sha384, _>(rng);
}
...
fn check_refresh_shares_with_dealer_serialisation() {
    ...
    frost_core::tests::refresh::check_refresh_shares_with_dealer_serialisation::<P384Sha384, _>(
        rng,
    );
}
...
fn check_refresh_shares_with_dealer_fails_with_unequal_num_identifiers_and_max_signers() {
    ...
    let min_signers = 3;
    let max_signers = 3;
    let error: frost_core::Error<P384Sha384> = Error::IncorrectNumberOfIdentifiers;
